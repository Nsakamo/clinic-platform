const MODEL_CATALOG = Object.freeze({
  "gpt-6-sol": { label: "GPT-6 Sol", tier: "highest" },
  "gpt-6-luna": { label: "GPT-6 Luna", tier: "fast" },
});

const TASK_DEFAULTS = Object.freeze({
  draft: { model: "gpt-6-sol", reasoningEffort: "medium" },
  chat: { model: "gpt-6-sol", reasoningEffort: "medium" },
  learning: { model: "gpt-6-sol", reasoningEffort: "high" },
  audit: { model: "gpt-6-sol", reasoningEffort: "medium" },
  classify: { model: "gpt-6-luna", reasoningEffort: "low" },
  critical: { model: "gpt-6-sol", reasoningEffort: "high" },
});
